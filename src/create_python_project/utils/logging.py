...
def setup_logging(log_dir: str | None = None) -> logging.Logger:
    ...
    # Create console handler - only show INFO and above (no DEBUG messages in terminal)
    console_handler = logging.StreamHandler()
    # Always use INFO level for console to keep terminal clean
    # DEBUG messages go only to file, never to console
